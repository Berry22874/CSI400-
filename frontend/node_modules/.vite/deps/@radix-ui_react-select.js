...
import {
  ...
  useLayoutEffect2
} from "./chunk-PQVLPGS5.js";
import {
  Primitive,
  createSlot,
  useComposedRefs
} from "./chunk-GDJKXMVZ.js";
import {
  require_jsx_runtime
...
var SelectTrigger = React7.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React7.useRef("touch");
...
var SelectContentImpl = React7.forwardRef(
  (props, forwardedRef) => {
    ...
    const handleItemLeave = React7.useCallback(() => content?.focus(), [content]);
...
var SelectBubbleInput = React7.forwardRef(
